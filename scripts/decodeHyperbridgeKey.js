// Usage: node scripts/decodeHyperbridgeKey.js
// Paste your request object below to compute the commitment

const { createQueryClient, IndexerClient, getRequestCommitment } = require("hyperbridge-sdk");
const { ethers } = require("ethers");

// --- CONFIG ---
// Paste your request object here (as sent to the dispatcher)
const requestObject = null; // <-- Set this to your request object, or leave null to skip
